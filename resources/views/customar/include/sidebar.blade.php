    <div class="card">
        ...
        <div class="card-body">
            ...
            <a href="{{ route('update-profile') }}"><button   class="btn w-100 btn-success my-2">Update Profile</button></a>
            <a href="{{ route('reset-password') }}"><button class="btn w-100 btn-success my-2">Reset Password</button></a>
